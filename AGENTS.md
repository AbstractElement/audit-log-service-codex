...
- Update README.md file every time when startup process changed or extended, configurations has been changed, new API or critical logic added;
- Every new feature should be developed in a separate git branch with prefix "feature/<name>";
